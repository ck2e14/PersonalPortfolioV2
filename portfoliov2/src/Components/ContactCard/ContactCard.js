...
export default function ContactCard() {
   return (
      <div className='contact-card-wrapper'>
         ...
         <a href="mailto:chriswkennedy@icloud.com" target="_blank" rel="noopener noreferrer" className="email-link contact-link">Email →  <span>chriswkennedy@icloud.com</span></a>
